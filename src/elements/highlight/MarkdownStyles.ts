...
export default css`[slot="markdown-html"] {
  ...
  font-family: var(--api-font-body1-font-family);
  font-size: var(--api-font-body1-font-size, 14px);
  font-weight: var(--api-font-body1-font-weight, 400);
  line-height: var(--api-font-body1-line-height, 20px);
}
...
[slot="markdown-html"] h6 {
  font-family: var(--api-font-title-font-family);
  font-size: var(--api-font-title-font-size, 20px);
  font-weight: var(--api-font-title-font-weight, 500);
  line-height: var(--api-font-title-line-height, 28px);
  color: var(--api-font-title-color);
}
...
[slot="markdown-html"] h1 {
  font-size: var(--api-font-display1-font-size, 34px);
  font-weight: var(--api-font-display1-font-weight, 400);
  letter-spacing: var(--api-font-display1-letter-spacing, -.01em);
  line-height: var(--api-font-display1-line-height, 40px);
...
[slot="markdown-html"] h2 {
  ...
  padding: var(--api-font-h2-padding);
  margin: var(--api-font-h2-margin);
}

[slot="markdown-html"] h3 {
  font-weight: var(--api-font-subhead-font-weight, 400);
  font-size: var(--api-font-subhead-font-size, 1.5em);
  line-height: 1.43;
  margin: var(--api-font-h3-margin);
}

[slot="markdown-html"] h4 {
  font-weight: var(--api-font-subhead-font-weight, 400);
  line-height: var(--api-font-subhead-line-height, 24px);
  font-size: 1.25em;
}
