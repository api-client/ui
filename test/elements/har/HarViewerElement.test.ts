...
import { AnypointCollapseElement } from '@anypoint-web-components/awc';
...
describe('HarViewerElement', () => {
  ...
  async function basicFixture(har?: any): Promise<HarViewerElement> {
    return fixture(html`<har-viewer .har="${har}"></har-viewer>`);
  }

  async function readHarFile(name: string): Promise<any> {
  ...
  describe('Data rendering', () => {
    ...
    it('entires are rendered by default', () => {
      const list = (element.shadowRoot.querySelector('anypoint-collapse') as AnypointCollapseElement);
  ...
  describe('Entry details rendering', () => {
    ...
    it('renders the response info tab', async () => {
      const tab = (details.querySelectorAll('anypoint-tabs anypoint-tab')[1] as HTMLElement);
      tab.click();
      await nextFrame();
      const tabs = details.querySelector('anypoint-tabs');
    ...
    it('renders the response content tab', async () => {
      const tab = (details.querySelectorAll('anypoint-tabs anypoint-tab')[3] as HTMLElement);
      tab.click();
      await nextFrame();
      const tabs = details.querySelector('anypoint-tabs');
    ...
    it('renders the cookies tab', async () => {
      const tab = (details.querySelectorAll('anypoint-tabs anypoint-tab')[4] as HTMLElement);
      tab.click();
      await nextFrame();
      const tabs = details.querySelector('anypoint-tabs');
